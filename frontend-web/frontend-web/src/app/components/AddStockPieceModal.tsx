...
const AddStockPieceModal: React.FC<AddStockPieceModalProps> = ({ onClose, onSubmit }) => {
      ...
      <div className={styles.modal}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className={styles.formGroup}>
            ...
            <input type="number" name="prxUnitaire" value={formData.prxUnitaire} onChange={handleChange} min="0" step="0.01" required />
          </div>
          <div className={styles.formGroup}>
