...
export default function Header({ children }: { children?: React.ReactNode }) {
  ...
  useEffect(() => {
    async function fetchUser() {
      try {
        ...
        setUser(userData);
        setNavItems(getNavItems(userData.role, t)); // تمرير الترجمة
      } catch (error) {
    ...
    fetchUser();
  }, [t]); // إعادة التحديث عند تغيير الترجمة
  ...
  const profileMenuItems = [
    { title: user?.username || t("header.guest"), id: "username" },
    { title: t("header.profile"), id: "profile" },
    { title: t("header.setting"), id: "setting" },
    { title: t("header.logout"), id: "logout" },
  ];
