...
from .views import LoginView, UtilisateurViewSet, MagasinierViewSet, OperateurViewSet, AdministrateurViewSet, ResponsableViewSet, TechnicienViewSet, CompanyViewSet
